...
func main() {
	os.Setenv("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/teacher-room") // Hapus jika akan melakukan deploy ke fly.io
...
func FlyURL() string {
	...
	return "https://yuliacitra-be2953868.fly.dev" // TODO: replace this
}
